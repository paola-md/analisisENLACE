...
foreach j of numlist 10/16{
	...
	*Escolaridad promedio de los profesores por escuela, número de docentes mujeres, total de personal,etc.
		...
		*Para el numero total de directivos docentes, docentes especiales y personal adm. se omitieron la categoria "OTROS" (únicamente para el cálculo de escolaridad promedio)
